<h1><p align="center"><img alt="protobuf.js" src="https://github.com/diotoborg/iure-mollitia-modi/raw/master/pbjs.svg" height="100" /><br/>protobuf.js</p></h1>
<p align="center">
  <a href="https://github.com/diotoborg/iure-mollitia-modi/actions/workflows/test.yml"><img src="https://img.shields.io/github/actions/workflow/status/diotoborg/iure-mollitia-modi/test.yml?branch=master&label=build&logo=github" alt=""></a>
  <a href="https://github.com/diotoborg/iure-mollitia-modi/actions/workflows/release.yaml"><img src="https://img.shields.io/github/actions/workflow/status/diotoborg/iure-mollitia-modi/release.yaml?branch=master&label=release&logo=github" alt=""></a>
...
Pick the variant matching your needs and replace the version tag with the exact [release](https://github.com/diotoborg/iure-mollitia-modi/tags) your project depends upon. For example, to use the minified full variant:
...
> In other words: `verify` indicates that calling `create` or `encode` directly on the plain object will [result in a valid message respectively] succeed. `fromObject`, on the other hand, does conversion from a broader range of plain objects to create valid messages. ([ref](https://github.com/diotoborg/iure-mollitia-modi/issues/748#issuecomment-291925749))
...
There is also an [example for streaming RPC](https://github.com/diotoborg/iure-mollitia-modi/blob/master/examples/streaming-rpc.js).

Note that the service API is meant for clients. Implementing a server-side endpoint pretty much always requires transport channel (i.e. http, websocket, etc.) specific code with the only common denominator being that it decodes and encodes messages.

### Usage with TypeScript

The library ships with its own [type definitions](https://github.com/diotoborg/iure-mollitia-modi/blob/master/index.d.ts) and modern editors like [Visual Studio Code](https://code.visualstudio.com/) will automatically detect and use them for code completion.
...
**ProTip!** Not as pretty, but you can [use decorators in plain JavaScript](https://github.com/diotoborg/iure-mollitia-modi/blob/master/examples/js-decorators.js) as well.
...
* [CHANGELOG](https://github.com/diotoborg/iure-mollitia-modi/blob/master/CHANGELOG.md)
* [Frequently asked questions](https://github.com/diotoborg/iure-mollitia-modi/wiki) on our wiki
...
You can also run [the benchmark](https://github.com/diotoborg/iure-mollitia-modi/blob/master/bench/index.js) ...

```
$> npm run bench
```

and [the profiler](https://github.com/diotoborg/iure-mollitia-modi/blob/master/bench/prof.js) yourself (the latter requires a recent version of node):
...
* Support for pre-ES5 environments (except IE8) can be achieved by [using a polyfill](https://github.com/diotoborg/iure-mollitia-modi/blob/master/lib/polyfill.js).
...
* For descriptor.proto interoperability, see [ext/descriptor](https://github.com/diotoborg/iure-mollitia-modi/tree/master/ext/descriptor)
...
```
$> git clone https://github.com/diotoborg/iure-mollitia-modi.git
$> cd protobuf.js
$> npm install
```
...
* If you have any special requirements, there is [the bundler](https://github.com/diotoborg/iure-mollitia-modi/blob/master/scripts/bundle.js) for reference.
